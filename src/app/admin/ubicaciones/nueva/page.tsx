import { createUbicacio } from '../actions'
...
export default function NuevaUbicacionPage() {
  return (
    <div>
      <h1 className="text-2xl font-bold text-zinc-800 mb-6">Nueva ubicación</h1>
      <form action={createUbicacio} className="flex flex-col gap-4 max-w-lg">
        <div>
        ...
        <div>
          ...
          <input name="label" required placeholder="Ej: Pista de Pràctiques Moto"
            className="w-full border border-zinc-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
        </div>
        <div>
          <label className="block text-xs font-medium text-zinc-700 mb-1">Dirección</label>
          <input name="adreca" placeholder="Ej: Rambla d'Aragó, 35"
            className="w-full border border-zinc-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
        </div>
        <div>
          <label className="block text-xs font-medium text-zinc-700 mb-1">URL Google Maps *</label>
          <input name="url_maps" required placeholder="https://maps.google.com/..."
            className="w-full border border-zinc-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
        </div>
        <div>
