  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="bg-[#0110D6] rounded-2xl p-6 text-white">
        <p className="text-sm text-blue-200 mb-1">Benvingut/da,</p>
      ...
      <div className="grid grid-cols-2 gap-3">
        {[
          { href: '/alumnes/videos', emoji: '🎬', label: 'Vídeos de classes', desc: 'Repeticions en línia' },
          { href: '/alumnes/horaris', emoji: '📅', label: 'Horaris', desc: 'Confirma assistència' },
          { href: '/alumnes/informacio', emoji: '📋', label: 'Informació', desc: 'Examen i documentació' },
        ].map((item) => (
